...
host = 'https://vpc-pdf-search-663a7hhym7shfw7zddy4jpmzxm.us-east-1.es.amazonaws.com' # the OpenSearch Service domain, e.g. https://search-mydomain.us-west-1.es.amazonaws.com
index = 'mygoogle'
datatype = '_doc'
...
def handler(event, context):
    print(f"Hanlder invoked. Event: {event}, Context: {context}")
    for record in event['Records']:
        print(f"Handling record. record: {record}")
