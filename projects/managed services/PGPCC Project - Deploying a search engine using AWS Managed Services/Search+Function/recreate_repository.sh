...
repository_name="gl-pdf-search-search-function-repository"
repository_description="GL Managed Services Project - Search Function"
...
git init
git add buildspec.yml lambda_function.py search-function.yaml
